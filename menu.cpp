...
void ShowApp(bool *p_open)
{
    ...
    ImGui::Begin("MoonInjector", p_open,
    ...
    if (g_ultralight_controller)
    {
        ...
        if (texture)
        {
            ...
            ImGui::GetWindowDrawList()->AddImageRounded(
                (ImTextureID) reinterpret_cast<uintptr_t>(texture), content_pos,
                ImVec2(content_pos.x + content_size.x, content_pos.y + content_size.y), ImVec2(0, 0), ImVec2(1, 1),
                IM_COL32_WHITE, 8.0f);
        }
    }
