...
The application utilizes an offline SQLite database to organize DLLs into customizable "Workspaces," allowing you to manage and deploy different injection targets with minimal effort.
...
* **BlackBone**: Located within the local project workspace under `./BlackBone`
